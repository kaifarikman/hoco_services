...
no_access = "Вас нет в Базе Данных. Для продолжения пользования ботом жмите /start"
yes_access = "Вы успешно зарегистрированы. Нажмите на /start для дальнейшего пользования ботом"
new_statement_text = "Введите описание вашей заявки или вопроса"
you_cant_send_voice_messages = "Вы не можете отправлять голосовые сообщения. Отправьте сообщение по заявке заново или выйдите в главное меню"
no_format_to_create_statement = "Данный формат заявки не поддерживается. Выйдите в главное меню или отправьте заявку заново"
to_long = "Слишком много медии в одном сообщении. Данный формат не поддерживается. Можете отправить данные заново или выйти в главное меню"
application_sent_for_moderation = "Заявка отправлена на модерацию. Ожидайте ответа"
submitting_meter_readings_text = "Необходимо подать показания счетчиков до 25 числа включительно"
...
ku_text = """Ваша заявка начисление КУ принята, ожидайте ответ в разделе "Мои заявки" """
rent_accuracy_text = """Ваша заявка начисление Аренды принята, ожидайте ответ в разделе "Мои заявки" """
request_for_reconciliation_report_text = """Ваша заявка запроса Акта и Сверки принята, ожидайте ответ в разделе "Мои заявки" """
